      ...
      <div class="row">
        <div class="col-xs-3">
          <div class="input-group">
            ...
            <input type="text" id="input_candidate_name" class="form-control" placeholder="名字" aria-describedby="basic-addon-name">
          </div>
        </div>
        <div class="col-xs-3">
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon-age">年龄:</span>
            <input type="number" id="input_candidate_age" class="form-control" placeholder="年龄" aria-describedby="basic-addon-age">
          </div>
        </div>
        <div class="col-xs-3">
          <div class="input-group">
        ...
        <div class="col-xs-3">
          <div class="input-group">
            ...
            <input type="number" id="input_candidate_workyear" class="form-control" placeholder="工作年限" aria-describedby="basic-addon-workyear">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xs-3">
          <div class="input-group">
            ...
            <input type="email" id="input_candidate_email" class="form-control" placeholder="邮箱" aria-describedby="basic-addon-email">
          </div>
        </div>
        <div class="col-xs-3">
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon-mobile">电话:</span>
            <input type="text" id="input_candidate_mobile" class="form-control" placeholder="电话" aria-describedby="basic-addon-mobile">
          </div>
        </div>
        <div class="col-xs-3">
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon-post">职位:</span>
            <input type="text" id="input_candidate_post" class="form-control" placeholder="职位" aria-describedby="basic-addon-post">
          </div>
        </div>
        <div class="col-xs-3">
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon-city">城市:</span>
            <input type="text" id="input_candidate_city" class="form-control" placeholder="城市" aria-describedby="basic-addon-city">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xs-3">
          <div class="input-group">
            ...
            <input type="text" id="input_candidate_company" class="form-control" placeholder="公司" aria-describedby="basic-addon-company">
          </div>
        </div>
        <div class="col-xs-9">
          <div class="input-group">
